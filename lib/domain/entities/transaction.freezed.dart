...
class _$TransactionImpl with DiagnosticableTreeMixin implements _Transaction {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Transaction(id: $id, uid: $uid, transactionTime: $transactionTime, transactionImage: $transactionImage, title: $title, seats: $seats, theaterName: $theaterName, watchingTime: $watchingTime, ticketAmount: $ticketAmount, ticketPrice: $ticketPrice, adminFee: $adminFee, total: $total, cleared: $cleared)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('transactionTime', transactionTime))
      ..add(DiagnosticsProperty('transactionImage', transactionImage))
      ..add(DiagnosticsProperty('title', title))
      ..add(DiagnosticsProperty('seats', seats))
      ..add(DiagnosticsProperty('theaterName', theaterName))
      ..add(DiagnosticsProperty('watchingTime', watchingTime))
      ..add(DiagnosticsProperty('ticketAmount', ticketAmount))
      ..add(DiagnosticsProperty('ticketPrice', ticketPrice))
      ..add(DiagnosticsProperty('adminFee', adminFee))
      ..add(DiagnosticsProperty('total', total))
      ..add(DiagnosticsProperty('cleared', cleared));
  }
...
abstract class _Transaction implements Transaction {
  const factory _Transaction(
      ...
      final bool cleared}) = _$TransactionImpl;
